...
public class CreateVerifyCodeUtil {
    ...
    public CreateVerifyCodeUtil() {
        creatImage();
    }

    public CreateVerifyCodeUtil(int width, int height) {
        this.width = width;
        this.height = height;
        creatImage();
    }

    public CreateVerifyCodeUtil(int width, int height, int codeCount) {
        this.width = width;
        this.height = height;
    ...
    public CreateVerifyCodeUtil(int width, int height, int codeCount, int lineCount) {
        this.width = width;
        this.height = height;
        this.codeCount = codeCount;
    ...
    public CreateVerifyCodeUtil(int width, int height, int codeCount, int lineCount, String code) {
        this.width = width;
        this.height = height;
        this.codeCount = codeCount;
        this.lineCount = lineCount;
