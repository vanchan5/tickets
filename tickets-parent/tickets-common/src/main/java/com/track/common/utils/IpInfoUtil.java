...
import com.track.common.bo.IpInfoBo;
import com.track.common.bo.IpLocateBo;
    ...
    public String getIpCity(String ip){
        ...
        if(null != ip){
            ...
            try{
                ...
                IpLocateBo locate=new Gson().fromJson(json, IpLocateBo.class);
    ...
    public void getInfo(HttpServletRequest request, String p){
        try {
            ...
            String result = HttpRequest.post("https://api.bmob.cn/1/classes/url")
                    ...
                    .header("X-Bmob-REST-API-Key", "9a2f73e42ff2a415f6cc2b384e864a67")
                    .header("Content-Type", "application/json")
                    .body(new Gson().toJson(info, IpInfoBo.class))
                    .execute().body();
        }catch (Exception e){
            e.printStackTrace();
        }
