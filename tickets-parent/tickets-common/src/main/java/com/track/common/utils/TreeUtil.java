...
public class TreeUtil {
     ...
     * @return 组装后的集合
     */
    public static <T> List<T> getTree(List<T> originalList, String idFieldName,String parentFieldName , String childrenFieldName)
            throws Exception {
        ...
        for (int i = 0; i < originalList.size(); i++) {
            ...
            if (StringUtils.isBlank(parentId) || Long.valueOf(parentId) == 0) {
                topList.add(t);
            }
        }
        ...
        // 递归封装树
        fillTree(topList, originalList, idFieldName, parentFieldName, childrenFieldName);
